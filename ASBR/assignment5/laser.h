...
// Laser sensor data
class BeamData : public amcl::AMCLSensorData{
public:
  
  BeamData () {ranges=NULL;};
  virtual ~BeamData() {delete [] ranges;};
...
class BeamLaser : public amcl::AMCLSensor{

  // Default constructor
public: BeamLaser(size_t max_beams, map_t* map);
  
public: virtual ~BeamLaser(); 
...
private: static double BeamModel(BeamData *data, 
					    pf_sample_set_t* set);
...
private: int max_beams;
  ...
  // Beam skipping parameters (used by BeamModelProb model)
